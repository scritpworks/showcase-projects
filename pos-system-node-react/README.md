...
|-----------------------|------------------|------------------|
| ![Login](images/01-login-selfie-gps.png) | ![Branches](images/02-branch-registration.png) | ![Roles](images/03-role-permission-setup.png) |

| Staff Registration | Salary Setup | Attendance Management |
|--------------------|---------------|------------------------|
| ![Staff](images/04-staff-registration.png) | ![Salary](images/05-salary-setup.png) | ![Attendance](images/06-attendance-management.png) |

| Product Management | POS Terminal | Sales History |
|--------------------|---------------|----------------|
| ![Products](images/07-product-management.png) | ![POS](images/08-pos-terminal.png) | ![Sales](images/09-sales-history.png) |
